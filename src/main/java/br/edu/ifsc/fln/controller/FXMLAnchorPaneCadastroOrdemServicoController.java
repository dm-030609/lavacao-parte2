...
public class FXMLAnchorPaneCadastroOrdemServicoController implements Initializable {
    ...
    @FXML private Label lbOrdemServicoTipoPessoa;
    ...
    public void selecionarItemTableViewOrdemServico(OrdemDeServico ordemDeServico) {
        if (ordemDeServico != null) {
            ...
            if (cliente instanceof PessoaFisica) {
                lbOrdemServicoTipoPessoa.setText("Pessoa Física");
            } else if (cliente instanceof PessoaJuridica) {
                lbOrdemServicoTipoPessoa.setText("Pessoa Jurídica");
            } else {
                lbOrdemServicoTipoPessoa.setText("Não identificado");
            }
